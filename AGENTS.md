...
核はこの 1 本。決定は `docs/adr/`（各 60 行、未卒業 5 本）。**正本は読者ごとに 1 つで、同じ内容を 2 箇所に書かない**: 開発者は README、利用者・審査者は `docs/privacy-policy.md` と `docs/support.md`、仕様は `docs/spec/kotonoha-requirements.md`、API の契約テスト基準は `backend/tests/contract/openapi_baseline.json`。
