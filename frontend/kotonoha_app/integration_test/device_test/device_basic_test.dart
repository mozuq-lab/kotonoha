...
/// 信頼性レベル: 青信号（NFR-401に基づく、RT-001〜RT-016）
///
...
void main() {
  ...
  group('実機基本動作テスト（iOS/Android共通）', () {
    ...
    testWidgets(
      ...
      (tester) async {
        // テスト目的: iOS/Android実機でアプリが正常に起動することを確認
        // 関連要件: NFR-401（iOS 14.0+、Android 10+）
    ...
    // ============================================================
    // RT-002: 文字盤タップ入力テスト（NFR-003: 100ms以内）
    // ============================================================
    testWidgets(
      'RT-002: 文字盤タップが100ms以内に反応する',
      (tester) async {
        // テスト目的: 文字盤タップの応答性能を確認
        // 関連要件: NFR-003（文字盤タップ応答100ms以内）
        // 手順: 「あ」ボタンをタップ
    ...
    // ============================================================
    // RT-003: TTS読み上げテスト（NFR-001: 1秒以内）
    // ============================================================
    testWidgets(
      'RT-003: TTS読み上げが1秒以内に開始される',
      (tester) async {
        // テスト目的: TTS読み上げ開始時間を確認
        // 関連要件: NFR-001（TTS読み上げ開始1秒以内）、REQ-401
    ...
    testWidgets(
      ...
      (tester) async {
        // テスト目的: 大ボタン機能を確認
        // 関連要件: REQ-201〜REQ-208（大ボタン・状態ボタン）
        // 手順: 「はい」ボタンタップ
        // 期待結果: 「はい」が即座に読み上げられる
        // 信頼性レベル: 青信号
    ...
    testWidgets(
      ...
      (tester) async {
        // テスト目的: フォントサイズ変更機能を確認
        // 関連要件: REQ-801（フォントサイズ変更）
        // 手順: 設定でフォントサイズ「大」に変更
    ...
    testWidgets(
      ...
      (tester) async {
        // テスト目的: 高コントラストモード機能を確認
        // 関連要件: REQ-5006（コントラスト比4.5:1以上）
