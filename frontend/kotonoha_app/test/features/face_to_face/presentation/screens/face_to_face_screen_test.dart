...
void main() {
  group('FaceToFaceScreenテスト', () {
    ...
    group('画面表示テスト', () {
      ...
      testWidgets('TC-052-010: 対面表示画面が表示されることを確認',
      ...
      testWidgets('TC-052-012: 戻るボタンが表示されることを確認',
          (WidgetTester tester) async {
    ...
    group('背景・スタイルテスト', () {
      ...
      testWidgets('TC-052-014: 背景がシンプルであることを確認',
          (WidgetTester tester) async {
    ...
    group('アクセシビリティテスト', () {
      ...
      testWidgets('戻るボタンのサイズが44px×44px以上であることを確認',
          (WidgetTester tester) async {
