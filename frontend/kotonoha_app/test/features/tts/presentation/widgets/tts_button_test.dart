...
void main() {
  group('TTSButtonウィジェットテスト', () {
    ...
    group('UI表示テスト', () {
      ...
      testWidgets('TC-050-001: アイドル状態で「読み上げ」ボタンが表示されることを確認', (WidgetTester tester) async {
        ...
        expect(find.text('読み上げ'), findsOneWidget); // 【確認内容】: 「読み上げ」ラベルが表示されていることを確認 🔵
      ...
      testWidgets('TC-050-002: 読み上げ中は「停止」ボタンに切り替わることを確認', (WidgetTester tester) async {
      ...
      testWidgets('TC-050-003: 読み上げ完了後は「読み上げ」ボタンに戻ることを確認', (WidgetTester tester) async {
      ...
      testWidgets('TC-050-004: ボタンサイズが44px×44px以上であることを確認', (WidgetTester tester) async {
        ...
        expect(buttonSize.width, greaterThanOrEqualTo(44)); // 【確認内容】: 幅が44px以上であることを確認 🟡
        expect(buttonSize.height, greaterThanOrEqualTo(44)); // 【確認内容】: 高さが44px以上であることを確認 🟡
      ...
      /// 優先度: P1（高優先度）
      /// 検証内容: スクリーンリーダー対応の確認
      testWidgets('TC-050-005: ボタンにSemanticsが設定されていることを確認', (WidgetTester tester) async {
    ...
    group('状態管理テスト', () {
      ...
      testWidgets('TC-050-006: 読み上げボタンタップでTTS読み上げが開始されることを確認', (WidgetTester tester) async {
      ...
      testWidgets('TC-050-007: 停止ボタンタップでTTS読み上げが中断されることを確認', (WidgetTester tester) async {
      ...
      testWidgets('TC-050-008: 停止後にidleに自動遷移することを確認', (WidgetTester tester) async {
        ...
        expect(state, anyOf(TTSState.stopped, TTSState.idle)); // 【確認内容】: 状態がstopped/idleであることを確認 🔵
      ...
      testWidgets('TC-050-009: 状態変更がRiverpodで正しく監視されることを確認', (WidgetTester tester) async {
