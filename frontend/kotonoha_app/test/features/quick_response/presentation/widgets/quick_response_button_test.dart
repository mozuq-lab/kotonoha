...
void main() {
  group('QuickResponseButton', () {
    ...
    group('イベントテスト', () {
      ...
      /// 「いいえ」タップ時にonTTSSpeakが「いいえ」で呼ばれる
      ...
      /// 「わからない」タップ時にonTTSSpeakが「わからない」で呼ばれる
