...
void main() {
  group('StatusButtonType', () {
    // 1.1 Enum定義テスト
    group('Enum定義テスト', () {
      /// StatusButtonTypeに必須の8個の値が定義されている
      ...
      /// StatusButtonTypeに最大12個の値が定義されている
    ...
    group('ラベル取得テスト', () {
      ...
      /// 全てのStatusButtonTypeに対応するラベルが存在する
