...
void main() {
  group('EmergencyButtonWithConfirmation', () {
    ...
    group('タップ・イベントテスト', () {
      ...
      /// 確認ダイアログで「はい」タップ後、onEmergencyConfirmedが呼ばれる
      ...
      /// 確認ダイアログで「いいえ」タップ後、onEmergencyConfirmedは呼ばれない
    ...
    group('アクセシビリティテスト', () {
      ...
      /// ボタンセマンティクス（button: true）が設定されている
    ...
    group('テーマ対応テスト', () {
      ...
      /// 高コントラストモードで純粋な赤色（#FF0000）で表示される
    ...
    group('TASK-0046 追加テスト: 連続タップ防止', () {
      ...
      /// 「いいえ」ボタン連続タップでonCancelledが1回だけ呼ばれる
