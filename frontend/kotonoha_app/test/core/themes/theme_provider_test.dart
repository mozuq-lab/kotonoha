/// テーマプロバイダーのテスト
/// テストケース
/// テスト対象: lib/core/themes/theme_provider.dart
library;
...
void main() {
  ...
  group('テーマプロバイダーのテスト', () {
    ...
    /// 設定がhighContrastの場合、highContrastThemeが返される
    /// 前提条件
    ...
    /// light -> dark -> highContrast の順序でテーマが正しく切り替わる
    /// 前提条件
    /// 初期状態でAppTheme.lightが設定されている
    /// 期待結果
    ...
    /// highContrast -> light への切り替えが正しく動作する
    /// 前提条件
