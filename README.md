...
- TASK-0040: 定型文一覧UI実装（34テストケース）
- TASK-0041: 定型文CRUD機能実装（83テストケース）
- TASK-0042: 定型文初期データ（87個サンプル）
- TASK-0043: 「はい」「いいえ」「わからない」大ボタン実装（57テストケース）
- TASK-0044: 状態ボタン実装（79テストケース）

**残タスク**:
- TASK-0045〜0047: 緊急ボタンUI・2段階確認・緊急音実装
- TASK-0048〜0051: TTS読み上げ機能（OS連携、速度設定、中断機能）
- TASK-0052〜0053: 対面表示モード・180度回転機能
- TASK-0054〜0060: ローカルストレージ・状態管理・統合テスト
