...
定型文の追加・編集フォームの本文とカテゴリは、「保存」を押すまで端末に保存しません。保存する前にアプリが終了すると、フォームに入力した内容は失われます。
...
The text and category in the add and edit forms for preset phrases are not stored on your device until you press Save. If the App closes before you save, what you entered in the form is lost.
