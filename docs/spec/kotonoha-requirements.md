...
- **EDGE-003**: ストレージ容量不足時、システムはユーザーに警告を表示し、古い履歴を優先的に削除する提案を行わなければならない *mvp-requirements-original.md 6-4から推測*（未達を受け入れ: Hive が box の書き込み失敗を報告しない。ADR-005 限界、台帳 L-13、2026-09-13）
