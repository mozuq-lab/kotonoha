...
- **REQ-203**: システムは初回に「トイレ」「暑い」「寒い」「水」「眠い」「助けて」「待って」「痛い」をこの順にお気に入りに用意し、利用者が削除した項目を再起動時に復活させてはならない *2026-09-26 ユーザー依頼*
...
- **REQ-707**: シンプルモードは固定の状態欄を設けず、表示順上位のお気に入りを最大8件と「はい」「いいえ」「わからない」の大ボタンを表示しなければならない *2026-09-26 ユーザー依頼*
